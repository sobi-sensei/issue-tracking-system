    ...
    <div className='min-h-screen flex flex-col md:flex-row'>
      ...
      <div className='flex-1 flex items-center justify-center p-6 sm:p-12 bg-white'>
        ...
        <div className='w-full max-w-md animate-fade-in'>
          ...
          <Link to='/login' className='inline-flex items-center gap-1 text-slate-400 hover:text-slate-500 text-sm mb-10 transition-colors'>
          ...
          <form className='space-y-5' onSubmit={handleSubmit}>
            <div>
              ...
              <input 
                ...
                required
                placeholder='sobisensei@playboymansion.com'
            ...
            <div>
              ...
              <div className='relative'>
                <input 
                  ...
                  required
                  className='w-full text-sm border border-slate-300 rounded-xl px-4 py-3 pr-11 outline-none focus:ring-2 focus:ring-indigo-500 transition-all' placeholder='**********'/>
            ...
            <button
              type='submit'
              disabled={loading}
              className='w-full py-3 bg-linear-to-r from-indigo-600 to-indigo-500 text-white rounded-md test-sm font-semibold hover:from-indigo-700 hover:to-indigo-600 disabled:opacity-50 transition-all duration-200 shadow-lg shadow-indigo-500/25 active:scale-[0.98] flex items-center justify-center'>
